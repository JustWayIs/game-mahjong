...
public enum Tile {
    ...
    // Enums
    // ===========================================================
    w1(11, "一万", "1", "w", Tile.TYPE_SIMPLES, CardEnum.万.getColor()),
    w2(12, "二万", "2", "w", Tile.TYPE_SIMPLES,  CardEnum.万.getColor()),
    w3(13, "三万", "3", "w", Tile.TYPE_SIMPLES,  CardEnum.万.getColor()),
    w4(14, "四万", "4", "w", Tile.TYPE_SIMPLES,  CardEnum.万.getColor()),
    w5(15, "五万", "5", "w", Tile.TYPE_SIMPLES,  CardEnum.万.getColor()),
    w6(16, "六万", "6", "w", Tile.TYPE_SIMPLES,  CardEnum.万.getColor()),
    w7(17, "七万", "7", "w", Tile.TYPE_SIMPLES,  CardEnum.万.getColor()),
    w8(18, "八万", "8", "w", Tile.TYPE_SIMPLES,  CardEnum.万.getColor()),
    w9(19, "九万", "9", "w", Tile.TYPE_SIMPLES,  CardEnum.万.getColor()),
    ...
    b1(31, "一筒", "1", "b", Tile.TYPE_SIMPLES, CardEnum.筒.getColor()),
    b2(32, "二筒", "2", "b", Tile.TYPE_SIMPLES, CardEnum.筒.getColor()),
    b3(33, "三筒", "3", "b", Tile.TYPE_SIMPLES, CardEnum.筒.getColor()),
    b4(34, "四筒", "4", "b", Tile.TYPE_SIMPLES, CardEnum.筒.getColor()),
    b5(35, "五筒", "5", "b", Tile.TYPE_SIMPLES, CardEnum.筒.getColor()),
    b6(36, "六筒", "6", "b", Tile.TYPE_SIMPLES, CardEnum.筒.getColor()),
    b7(37, "七筒", "7", "b", Tile.TYPE_SIMPLES, CardEnum.筒.getColor()),
    b8(38, "八筒", "8", "b", Tile.TYPE_SIMPLES, CardEnum.筒.getColor()),
    b9(39, "九筒", "9", "b", Tile.TYPE_SIMPLES, CardEnum.筒.getColor()),
